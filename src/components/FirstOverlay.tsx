...
export default function FirstOverlay({ 
  ...
  { stringIndex: 0, startFret: -6,  numFrets: 5, gridStyle: styles.thirdGrid },  // Top string (high E): shifted 1 right
    { stringIndex: 1, startFret: -8,  numFrets: 7, gridStyle: styles.fourthGrid }, // String 2: 7 columns
  { stringIndex: 2, startFret: -9,  numFrets: 5, gridStyle: styles.thirdGrid },  // String 3 (G): shifted 1 fret right
    { stringIndex: 3, startFret: -11, numFrets: 7, gridStyle: styles.fourthGrid }, // String 4: 7 columns
    { stringIndex: 4, startFret: -11, numFrets: 5, gridStyle: styles.thirdGrid },  // String 5 (A): 5 columns, shifted 1 fret right
    { stringIndex: 5, startFret: -1,  numFrets: 7, gridStyle: styles.fourthGrid }, // Bottom string (low E): 7 columns
  ];
